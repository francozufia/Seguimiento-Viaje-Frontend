...
const ChatComponent = () => {
  ...
  const sendMessage = () => {
    if (stompClientRef.current.connected) { // Verificar si está conectado
      ...
      console.error('Error: No se pudo enviar el mensaje. WebSocket no está activo o no conectado.');
    }
  };
